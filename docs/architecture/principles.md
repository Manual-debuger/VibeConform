...
| 1 | Claude Code `PreToolUse` hooks block destructive commands at the tool-call level, not by asking nicely (Codex hooks are suspended: on Windows Codex ignores the deny, spec 0024) |
